...
let init() : Model * Cmd<Msg> =
  { I18nEn = I18n(Fable.Core.JsInterop.importDefault(__SOURCE_DIRECTORY__ + "/test/strings.en.json"), "en")
    I18nFr = I18n(Fable.Core.JsInterop.importDefault(__SOURCE_DIRECTORY__ + "/test/strings.fr.json"), "fr")
    Name = ""
    Count = 0. }, Cmd.none
